            ...
            <div class="row" id="search-user">
                <form method="post">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <input style="color:black" class="form-control form-control-lg form-control-borderless" id="searchInput" type="search" placeholder="Search film for name, director, actor,..." name="qry">
                        </div>
                        <div class="col-md-4">
